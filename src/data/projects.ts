...
export const projectsData: AppProject[] = [
  {
    ...
    slug: 'luxury-bedroom',
    image: bed1,
    description: 'A sophisticated luxury bedroom design focusing on elegant textures, ambient lighting, and bespoke furniture pieces to create a tranquil sanctuary. Featuring premium upholstered bedframes with integrated backlighting and seamless wardrobe integration.',
  ...
  */
  ...
  },
  {
    ...
    slug: 'salon-interior',
    image: salon1,
    description: 'A chic and modern salon interior designed to provide a relaxing and luxurious experience for clients, featuring bespoke styling stations and vibrant lighting.',
    location: 'Bhubaneswar, Odisha',
