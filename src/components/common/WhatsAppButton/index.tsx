...
// Import a local SVG or use an icon, here we use an inline SVG for the WhatsApp logo
const WhatsAppIcon = () => (
...
export const WhatsAppButton: React.FC = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      buttonRef.current,
      { scale: 0, opacity: 0 },
      { scale: 1, opacity: 1, duration: 0.6, delay: 1, ease: 'back.out(1.5)' }
    );
  }, []);

  return (
    <a 
      href="https://wa.me/917008325017" 
      target="_blank" 
    ...
    >
      ...
      <span className="whatsapp-tooltip">Quick Chat</span>
    </a>
  );
};
